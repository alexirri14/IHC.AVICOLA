...
namespace IHC.AVICOLA
{
    public static class DataManager
    {
        ...
        {
            // Suma de sacos 50kg, 25kg y aceite
            return 100 + 50 + 30 + 15 + 25 + 35; // Suma aproximada de los sacos de ejemplo
        }
        ...
        public static int ObtenerHuevosHoy()
        {
            ...
            // Si no hay datos de hoy, usamos los últimos datos de ejemplo
            if (total == 0)
            {
                foreach (DataRow row in Produccion.Rows)
                {
                ...
                total = total / Produccion.Rows.Count; // Promedio por día
            }
            return total;
        }
